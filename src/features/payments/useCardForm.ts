...
const DEMO_CARD_NUMBERS = new Set(["4242424242424242", "5555555555554444"]);

export const isDemoCardNumber = (value: string): boolean => DEMO_CARD_NUMBERS.has(value.replace(/\D/g, ""));
